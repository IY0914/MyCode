...
private:
	...
	{ L"Resources/Texture/Stage1Select.png",
	  L"Resources/Texture/Stage2Select.png",
	  L"Resources/Texture/Stage3Select.png" };
...
public:
	SelectScene(DX::DeviceResources* m_pDR, DirectX::Keyboard* key, DirectX::Mouse* mouse);
	~SelectScene();
